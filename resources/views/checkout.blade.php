...
{{--                                    <input type="text" name="payment_method" class="form-control" id="postcode" value="" required>--}}
{{--                                </div>--}}
{{--                                <div class="col-12 mb-3">--}}
...
{{--                                <li><span>Product</span><span>Price</span><span>Quantity</span></li>--}}
{{--                                @forelse($cart as $k)--}}
{{--                                <li><span>{{$k->product_name}}</span>{{$k->price}}<span>{{$k->cart_qty}}</span></li>--}}
{{--                                @empty--}}
{{--                                <li><span>No product</span></li>--}}
{{--                                @endforelse--}}
{{--    --}}{{--                            <li><span>Subtotal</span> <span>$59.90</span></li>--}}
{{--    --}}{{--                            <li><span>Shipping</span> <span>Free</span></li>--}}
{{--                                <li><span>Total</span><h3>$59.90</h3></li>--}}
{{--                            </ul>--}}
                        </table>
                        <ul class="order-details-form mb-4">
                            <div class="container">
